...
Korisnička shema nema jednostavan atribut \emph{password} kako je to prikazano u isječku kôda \ref{lst:schema}, već u sebi sadrži metodu postavljanja \engl{setter} koja osigurava da se u bazi ne sprema izravno korisnikova zaporka, već da se generira njen sažetak \engl{hash}.
