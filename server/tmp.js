const exercise = {
	code: 'bmi-01',
	title: 'Rođendani visokih učenika',
	// eslint-disable-next-line max-len
	description: 'Prikaži redni broj, ime, prezime, i datum rođenja svih muških učenika koji su visoki barem 132 cm i imaju ispod 31 kg te svih ženskih učenica koje su visoke barem 131 cm i imaju ispod 30 kg',
	input: {
		'keys': [
			'Redni broj',
			'Ime',
